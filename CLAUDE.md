...
- **Cross-model review (Codex xhigh) required** before merging PRs that touch methodology, model recommendations, setup skill, hooks, or CI. Run even for "obvious" changes — incident 2026-06-09: 4 PRs merged without Codex review, all had issues
